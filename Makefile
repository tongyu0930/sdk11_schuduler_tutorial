PROJECT_NAME := schedular_tutorial_pca10040
...
nrf52832_xxaa: LINKER_SCRIPT=schedular_tutorial_gcc_nrf52.ld
...
flash: nrf52832_xxaa
	@echo Flashing: $(OUTPUT_BINARY_DIRECTORY)/$<.hexld
